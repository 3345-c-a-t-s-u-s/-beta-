		...
		local function main()
			...
			Explorer.StartDrag = function(offX,offY)
				...
				mouseEvent = input.InputChanged:Connect(function(input)
					if (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch ) or input.UserInputType == Enum.UserInputType.Touch then
						move()
					end
				end)
			...
			Explorer.NewListEntry = function(index)
				...
				newEntry.InputBegan:Connect(function(input)
					...
					if not node or selection.Map[node] or (input.UserInputType ~= Enum.UserInputType.MouseMovement or  input.UserInputType ~= Enum.UserInputType.Touch ) then return end
		...
		local function main()
			...
			Properties.NewPropEntry = function(index)
				...
				nameFrame.PropName.InputBegan:Connect(function(input)
					local prop = viewList[index + Properties.Index]
					if not prop then return end
					if ((input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch ) or  input.UserInputType == Enum.UserInputType.Touch ) and not nameFrame.PropName.TextFits then
				...
				nameFrame.PropName.InputEnded:Connect(function(input)
					if ((input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch ) or  input.UserInputType == Enum.UserInputType.Touch )and Properties.FullNameFrameIndex == index then
		...
		local function main()
			...
			Lib.ButtonAnim = function(button,data)
				...
				button.InputEnded:Connect(function(input)
					if disabled then return end
					if (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch ) or  input.UserInputType == Enum.UserInputType.Touch  and not holding then
						if mode == 1 then
			...
			Lib.ScrollBar = (function()
				...
				local function createFrame(self)
					...
					button1.InputBegan:Connect(function(input)
						if ((input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch ) or input.UserInputType == Enum.UserInputType.Touch ) and not buttonPress and self:CanScrollUp() then button1.BackgroundTransparency = 0.8 end
					...
					button1.InputEnded:Connect(function(input)
						if ((input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch ) or  input.UserInputType == Enum.UserInputType.Touch ) and not buttonPress then button1.BackgroundTransparency = 1 end
					end)
					button2.InputBegan:Connect(function(input)
						if ((input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch ) or input.UserInputType == Enum.UserInputType.Touch ) and not buttonPress and self:CanScrollDown() then button2.BackgroundTransparency = 0.8 end
